  ...
  describe "POST /admin/books" do
    context "with valid parameters" do
      it "creates a new book and responds with Turbo Stream" do
        post admin_books_path, params: { book: { title: 'New Book', description: 'Description', language: 'en' } }, headers: { 'Accept' => 'text/vnd.turbo-stream.html' }
    ...
    context "with invalid parameters" do
      it "does not create a new book and responds with Turbo Stream" do
        post admin_books_path, params: { book: { title: '', description: '', language: '' } }, headers: { 'Accept' => 'text/vnd.turbo-stream.html' }
  ...
  describe "PATCH /admin/books/:id" do
    context "with valid parameters" do
      it "updates the book and responds with Turbo Stream" do
        patch admin_book_path(book), params: { book: { title: 'Updated Title' } }, headers: { 'Accept' => 'text/vnd.turbo-stream.html' }
    ...
    context "with invalid parameters" do
      it "does not update the book and responds with Turbo Stream" do
        patch admin_book_path(book), params: { book: { title: '' } }, headers: { 'Accept' => 'text/vnd.turbo-stream.html' }
  ...
  describe "POST /admin/books/:id/create_translation" do
    context "with valid parameters" do
      it "creates a new translation and responds with Turbo Stream" do
        post create_translation_admin_book_path(book), params: { book: { title: 'Translation Title', description: 'Translation Description', language: book.available_languages.sample } }, headers: { 'Accept' => 'text/vnd.turbo-stream.html' }
    ...
    context "with invalid parameters" do
      it "does not create a new translation and responds with Turbo Stream" do
        post create_translation_admin_book_path(book), params: { book: { title: '', description: '', language: '' } }, headers: { 'Accept' => 'text/vnd.turbo-stream.html' }
