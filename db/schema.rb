...
ActiveRecord::Schema[8.0].define(version: 2025_01_04_192226) do
  ...
  create_table "chapter_translations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["chapter_id", "language"], name: "index_chapter_translations_on_chapter_id_and_language", unique: true
